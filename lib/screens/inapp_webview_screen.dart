  ...
  static Future<void> _init() async {
    ...
    if (Platform.isAndroid || Platform.isIOS || Platform.isMacOS) {
      ...
      _defaultUserAgentWithKaring =
          "$_defaultUserAgent SkiVPN/${AppUtils.getBuildinVersion()}";
    } else {
      ...
      _defaultUserAgentWithKaring =
          "$userAgent SkiVPN/${AppUtils.getBuildinVersion()}";
    }
    _inited = true;
  }
...
class _InAppWebViewScreenState extends State<InAppWebViewScreen> {
  ...
  void initState() {
    ...
    if (widget.setJSWindowObject) {
      _scripts.add(
        UserScript(
          source:
              "window.addEventListener('DOMContentLoaded', function(event) {window.ski = window.flutter_inappwebview;});",
  ...
  void setJavaScriptHandler() {
    ...
    /*
    window.ski.callHandler('close').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
    ...
    window.ski.callHandler('version').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
        var event = new Event('error');
    ...
    window.ski.callHandler('openUrl', 'ski://install-config?url=#testname').then(function(result) {
     ...
     window.ski.callHandler('openUrl', 'ski://disconnect').then(function(result) {
        console.log(result);
        return result;
    }).catch(function() {
        var event = new Event('error');
