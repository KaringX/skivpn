...
class XboardRegisterScreen extends StatefulWidget {
  ...
  const XboardRegisterScreen({super.key, required this.provider});
  @override
  State<XboardRegisterScreen> createState() => _RegisterScreenState();
}

class _RegisterScreenState extends State<XboardRegisterScreen> {
