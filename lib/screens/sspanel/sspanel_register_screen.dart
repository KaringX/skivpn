...
class SSPanelRegisterScreen extends StatefulWidget {
  ...
  const SSPanelRegisterScreen({super.key, required this.provider});
  @override
  State<SSPanelRegisterScreen> createState() => _RegisterScreenState();
}

class _RegisterScreenState extends State<SSPanelRegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isEmailVerify = _isEmailVerify;
    bool isRecaptcha = _isRecaptcha;
    String recaptcha = _recaptcha;

    /* if (_config != null) { //todo
      loading = false;
